function [raiz, tabla, iter, converge] = newton(f, df, x0, tol, maxIter)
% newton - Metodo de Newton-Raphson para encontrar raices de f(x)=0.
%   [raiz, tabla, iter, converge] = newton(f, df, x0, tol, maxIter)
%
%   Entradas:
